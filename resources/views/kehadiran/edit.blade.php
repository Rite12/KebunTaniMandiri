            ...
            <form method="POST" action="{{ route('kehadiran.update', $kehadiran->id) }}">
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="time" name="waktu_masuk" id="waktu_masuk" class="form-control" 
                        value="{{ old('waktu_masuk', $kehadiran->waktu_masuk ?? '') }}" required>
                </div>
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="time" name="waktu_keluar" id="waktu_keluar" class="form-control" 
                        value="{{ old('waktu_keluar', $kehadiran->waktu_keluar ?? '') }}" required>
                </div>

                <!-- Gaji Lembur -->
                <div class="form-group mt-3">
                    <label for="gaji_lembur">Gaji Lembur (Rp)</label>
                    <input type="text" name="gaji_lembur" id="gaji_lembur" class="form-control" 
                        value="{{ old('gaji_lembur', number_format($kehadiran->gaji_lembur ?? 0, 0, ',', '.')) }}" required>
                </div>
